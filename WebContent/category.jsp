...
<%
String cc_id = request.getParameter("c_id");
sql = "select * from books where c_id = "+ cc_id +" and b_status = -1 and u_id <> '"+session.getAttribute("currentUser")+"' order by b_time desc limit 0,3";
